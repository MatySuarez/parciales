            ...
            do {
                menu = JOptionPane.showInputDialog(null,
                        "Bienvenido \n" +  nombreCliente + "\n" + "\nIngrese su opción: \n(Solamente la letra)" + "\n" +
                                ...
                                "\n- E: Salir." + "\n" , "Menú Cajero", JOptionPane.PLAIN_MESSAGE);
                ...
                if (menu.equalsIgnoreCase("A")) {
                    ...
                    double cantidad = Double.parseDouble(JOptionPane.showInputDialog(null, "Ingrese el importe a depositar", "Menú Cajero", JOptionPane.PLAIN_MESSAGE));
                    depositar(cantidad);
                    ...
                    double cantidad = Double.parseDouble(JOptionPane.showInputDialog(null, "Ingrese el importe a retirar", "Menú Cajero", JOptionPane.PLAIN_MESSAGE));
                    retirar(cantidad);
                    ...
                    JOptionPane.showMessageDialog(null, "Adios " + nombreCliente + ", gracias por elegirnos", "Menú Cajero", JOptionPane.PLAIN_MESSAGE);
                    System.exit(0);
                } else {
                    JOptionPane.showMessageDialog(null, "Opción inválida, intentelo nuevamente", "Error", JOptionPane.ERROR_MESSAGE);
                }
